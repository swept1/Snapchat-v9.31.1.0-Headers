...
@class AddFriendsDelegateObject, EGORefreshTableHeaderView, Friend, NSArray, NSDictionary, NSMutableArray, NSMutableSet, NSString, SCAlertGear, SCContactsAccessViewController, SCIndexedTableView, SCMiniProfileController, SCMyFriendsHeader, SCSearchFriendsSubViewController, SCUserSession, UIView;
...
- (id)_formatSubLabelTextForPhoneNumbers:(id)arg1;
- (id)userSession;
