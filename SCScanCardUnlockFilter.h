...
@class CLLocation, NSString, NSURL, SCGeoFilter, UIButton, UIImage, UIImageView, UILabel, UIView;
...
@interface SCScanCardUnlockFilter : SCScanCardTableViewCell
{
    ...
    SCGeoFilter *_filter;
    UIButton *_unlockFilterButton;
    NSString *_scanData;
    UIButton *_cancelButton;
    unsigned long long _currentButtonStyle;
