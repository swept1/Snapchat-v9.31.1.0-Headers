...
@interface SCOperaVideoLayerViewController : UIViewController <SCOperaLayerViewController, SCOperaDockableViewController>
{
    ...
    id <SCOperaVideoLayerViewControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <SCOperaVideoLayerViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
