...
- (id)initWithSuggestedFriendResults:(id)arg1 message:(id)arg2 logged:(id)arg3 suggestedFriendResultsV2:(id)arg4 addFriendsFooterOrdering:(id)arg5 storiesPageOrdering:(id)arg6 sendToPageOrdering:(id)arg7;
