...
- (id)initWithMedia:(id)arg1 medias:(id)arg2 sticker:(id)arg3 type:(id)arg4 text:(id)arg5 attributes:(id)arg6 mediaCardAttributes:(id)arg7 storyTitle:(id)arg8 obfuscation:(id)arg9;
