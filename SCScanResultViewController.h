...
#import "SCScanCardDiscoverDeepLinkDelegate.h"
#import "SCScanCardProviderDelegate.h"

@class NSArray, NSMutableArray, NSString, SCDiscoverEditionPresenter, SCScanCardDiscoverDeepLink, SCScanCardProvider, SCScanCardTableViewCell, SCUserSession, Sound, UITapGestureRecognizer;

@interface SCScanResultViewController : SCCameraCardViewController <SCDiscoverEditionPresenterDelegate, SCScanCardProviderDelegate, SCCameraCardViewControllerDelegate, SCScanCardDiscoverDeepLinkDelegate, SCDeepLinkableView>
{
    ...
    SCScanCardDiscoverDeepLink *_deepLinkScanCard;
...
- (void)discoverDeepLinkCard:(id)arg1 didTapShareUrl:(id)arg2;
- (void)discoverDeepLinkCard:(id)arg1 didDeepLinkToURL:(id)arg2;
...
- (void)cameraCardTableViewCell:(id)arg1 willAnimateHeightWithAnimations:(CDUnknownBlockType)arg2;
