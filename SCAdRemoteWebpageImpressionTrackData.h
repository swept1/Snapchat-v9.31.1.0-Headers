...
@interface SCAdRemoteWebpageImpressionTrackData : NSObject <SCSnapAdsSerializableData>
{
...
- (id)initWithTopsnapTimeViewedSeconds:(id)arg1 longformTimeViewedSeconds:(id)arg2 swiped:(id)arg3;
