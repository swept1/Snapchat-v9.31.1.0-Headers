...
- (id)initWithServerInfo:(id)arg1 messagingGatewayInfo:(id)arg2 updatesResponse:(id)arg3 friendsResponse:(id)arg4 storiesResponse:(id)arg5 conversationsResponse:(id)arg6 conversationsResponseInfo:(id)arg7 discover:(id)arg8 identityCheckResponse:(id)arg9 sponsored:(id)arg10 supportToolsResponse:(id)arg11 message:(id)arg12 status:(id)arg13 dtoken1i:(id)arg14 dtoken1v:(id)arg15 twoFaNeeded:(id)arg16 username:(id)arg17 messageFormat:(id)arg18 phoneNumber:(id)arg19 preAuthToken:(id)arg20 recoveryCodeUsed:(id)arg21 isSmsTwoFaEnabled:(id)arg22 isOtpTwoFaEnabled:(id)arg23 verificationNeeded:(id)arg24 latestOutAlpha:(id)arg25 latestBackupOutBeta:(id)arg26 reactivationStatus:(id)arg27;
