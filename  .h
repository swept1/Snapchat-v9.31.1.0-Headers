...
@class NSMutableArray, NSMutableDictionary, NSMutableSet, NSNumber, NSString, NSTimer, SCCameraOverlayView, SCCameraTimer, SCCameraVerticalScrollView, SCCameraVolumeButtonHandler, SCManagedCapturerState, SCMiniProfileController, SCNearbyPopupController, SCProfilePictureController, SCProfileView, SCRecordedVideo, SCShareUsernameController, SCUserSession, SnapTrophyMetrics, UIButton, UIImageView, UILabel, UIToolbar, UIView, UIViewController<SCGalleryViewController>;

@interface   : UIViewController <SCManagedCapturerListener, SendSnapNavigationControllerDelegate, SCGalleryViewControllerDelegate, SCGalleryReturnButtonControlDelegate, SCIAPTOSVCDelegate, SCScanResultViewControllerDelegate, SCGalleryIconControllerDelegate, SCShareUsernameControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, SCCameraVolumeButtonHandlerDelegate, SCTimeProfilable, SCProfilePictureControllerDelegate, SwipeView, UIGestureRecognizerDelegate, SCCameraOverlayDelegate, UIScrollViewDelegate, SCProfileViewDelegate, SCDeepLinkableViewSource, SCMiniProfileControllerDelegate>
{
