...
- (void)updateStatusTextForFriendStoriesCellWithFriendStories:(id)arg1 forViewingType:(long long)arg2 selected:(_Bool)arg3;
...
- (void)setSelected:(_Bool)arg1 withFriendStories:(id)arg2 forViewingType:(long long)arg3;
