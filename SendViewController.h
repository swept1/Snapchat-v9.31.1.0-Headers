...
@class FBKVOController, Friend, LoadingView, NSArray, NSDictionary, NSMutableDictionary, NSString, SCFindFriendMenuViewController, SCLocationController, SCLocationHeaderView, SCSelectRecipientsView, SCSendConfirmationView, SCSendViewControllerDismissalAnimator, SCUserSession, SendTextController, Snap, UIImageView, UIView;

@interface SendViewController : UIViewController <SCSelectGroupRecipientsDelegate, SCSendConfirmationViewControllerDelegate, SCHeaderDataSource, SCHeaderDelegate, SCMiniProfileControllerDelegate, SendTextControllerDelegate, SCTimeProfilable, UITextFieldDelegate, UIAlertViewDelegate, SCLocationHeaderViewDelegate, SCInviteSnapSenderDelegate>
{
...
- (void)_updateInviteSnapsStatusToServer:(id)arg1;
