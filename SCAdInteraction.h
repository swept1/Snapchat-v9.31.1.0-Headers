...
@property(nonatomic) NSString *adKey; // @synthesize adKey=_adKey;
...
@property(retain, nonatomic) NSDate *adMediaFirstRenderTimestamp; // @synthesize adMediaFirstRenderTimestamp=_adMediaFirstRenderTimestamp;
@property(nonatomic) double adMediaDuration; // @synthesize adMediaDuration=_adMediaDuration;
@property(retain, nonatomic) NSString *adMediaType; // @synthesize adMediaType=_adMediaType;
@property(retain, nonatomic) NSDate *currentSessionStartTimestamp; // @synthesize currentSessionStartTimestamp=_currentSessionStartTimestamp;
