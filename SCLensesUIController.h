...
@class NSArray, NSString, SCAlertViewActionButtonController, SCCameraOverlayView, SCCameraTimer, SCGrowingButton, SCLens, SCLensesPhotoPickerUIController, SCSponsoredSlugView, UICollectionView, UILabel, UITapGestureRecognizer, UIView;

@interface SCLensesUIController : NSObject <SCLensDataProviderDelegate, TTTAttributedLabelDelegate, SCTimeProfilable, LSAEffectsManagerListener, UICollectionViewDelegate, UICollectionViewDataSource>
{
...
- (void)activateLensWithID:(id)arg1 contentPath:(id)arg2;
- (void)clearLens;
