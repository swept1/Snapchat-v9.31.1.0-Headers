...
- (void)logStoryCellView:(id)arg1 numStoryCells:(unsigned long long)arg2 channelsSeen:(id)arg3 liveStoriesSeen:(id)arg4 storyRecentUpdatesPostersIds:(id)arg5 sortOrderId:(id)arg6;
