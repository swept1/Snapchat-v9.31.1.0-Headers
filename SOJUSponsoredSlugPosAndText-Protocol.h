...
@property(readonly, copy, nonatomic) NSNumber *slugRemainsAfterPulsing;
@property(readonly, copy, nonatomic) NSNumber *pulseViewBackgroundOpacity;
@property(readonly, copy, nonatomic) NSNumber *pulseBreakDurationMillis;
@property(readonly, copy, nonatomic) NSNumber *pulseDurationMillis;
@property(readonly, copy, nonatomic) NSNumber *pulsesCount;
@property(readonly, copy, nonatomic) NSNumber *pulseViewStartingOpacity;
